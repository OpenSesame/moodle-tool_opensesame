...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_configtext('tool_opensesame/max_consecutive_fails',
        get_string('max_consecutive_fails', 'tool_opensesame'),
        get_string('max_consecutive_fails_desc', 'tool_opensesame'), 5, PARAM_INT));
